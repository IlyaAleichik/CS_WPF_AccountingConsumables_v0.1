    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show(ex.Message + " \nПодождите программа выполняет создание новой базы данных");
        ...
        private void TypeMaterial_Click(object sender, RoutedEventArgs e)
        {
            ...
            string sql = "SELECT NameTypeMaterial as [Наименования типов] FROM TypeMaterial";
            table = new DataTable();
            try
            {
                connection = new SqlConnection(connectionString);
        ...
        {
            string sql = "SELECT NameOrganization as Организация,Phone as Телефон,AddresProviders as Адрес FROM Providers";
            table = new DataTable();
            try
            {
                connection = new SqlConnection(connectionString);
        ...
        {
            string sql = "SELECT  NameCategory as [Наименования категорий] FROM Category";
            table = new DataTable();
            try
            {
                connection = new SqlConnection(connectionString);
        ...
        {
            string sql = "SELECT NameDep as [Наименования подразделений] FROM Departament";
            table = new DataTable();
            try
            {
                connection = new SqlConnection(connectionString);
